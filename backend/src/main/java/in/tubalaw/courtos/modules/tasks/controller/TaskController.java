...
public class TaskController {
    ...
    public ResponseEntity<ApiResponse<List<Task>>> list(@RequestParam(required = false) String status) {
        return ResponseEntity.ok(ApiResponse.ok(taskService.list(status)));
    }
